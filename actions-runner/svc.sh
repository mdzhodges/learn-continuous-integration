...
SVC_NAME="actions.runner.mdzhodges-learn-continuous-integration.Matthews-MacBook-Pro-2"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (mdzhodges-learn-continuous-integration.Matthews-MacBook-Pro-2)"
